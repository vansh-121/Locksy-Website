                    ...
                    {[
                      ...
                      <tr key={idx} className="border-b border-border/50 hover:bg-accent/30 transition-colors">
                        ...
                        <td className="py-4 px-4 md:px-6 text-center">
                          {row[1] ? (
                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-green-500/20 text-green-600 font-bold">✓</span>
                          ) : (
                            <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-red-500/20 text-red-600 font-bold">×</span>
                          )}
                        </td>
                        <td className="py-4 px-4 md:px-6 text-center">
                          {row[2] ? (
