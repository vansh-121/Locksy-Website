          ...
          <div className="space-y-10 z-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="inline-flex items-center justify-center bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-0.5 hover:scale-[1.02] px-6 py-3 border border-primary/10 group"
              >
                <span className="flex items-center gap-3">
                  ...
                  <span className="flex flex-col items-start">
                    ...
                    <span className="font-semibold text-foreground group-hover:text-primary transition-colors">Google Chrome</span>
                  </span>
                </span>
              </a>
              <a
              ...
              >
                <span className="flex items-center gap-3">
                  ...
                  <span className="flex flex-col items-start">
                    <span className="text-xs text-muted-foreground">Get it for</span>
                    <span className="font-semibold text-foreground group-hover:text-primary transition-colors">Microsoft Edge</span>
                  </span>
                </span>
              </a>
              <a
